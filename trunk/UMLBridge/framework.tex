...
\ivano{tanto testo per dire poco}
...
\begin{figure}
  \centering
  \subfloat[]{\label{fig:slicerMM}\includegraphics[scale=0.255]{figures/slicingIdea.png}}
	\hspace{2mm}
  \subfloat[]{\label{fig:slicerT}\includegraphics[scale=0.255]{figures/slicingIdea.png}}
	\hspace{2mm}
  \subfloat[]{\label{fig:slicerT}\includegraphics[scale=0.255]{figures/slicingIdea.png}}
...
The remainder of the section is organized as follows: firstly we will describe how the set of relevant UML concepts can be 
defined by designers, and then we will discuss how both the target MOF metamodel and the generated model-to-model transformations
are sliced according to the selected UML relevant concepts.
...
\begin{enumerate}
	...
	\item designers specify only the types of UML diagram they will use (e.g., activity and sequence diagrams), and the corresponding annotation model is automatically generated;
...
\end{enumerate}
\ivano{spiegare meglio e di piu come si fa lo slicing}
...
\ivano{preso as is? dire qual e' il contributo}. Let
...
For example, by referring to Figure \ref{fig:} \ivano{completare con la motivazione del perche' ci serve slicare anche la trasf}
...
\ivano{qui almeno diciamo la strategia e qualche implementation detail}
