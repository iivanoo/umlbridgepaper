...
Atlas Transformation Language (ATL)~\cite{3}, a hybrid model transformation language with both declarative and imperative constructs (Listing \ref{lst:generatedTransf}\henry{to add} shows an excerpt of ATL code).
