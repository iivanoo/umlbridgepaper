...
\henry{mi pare di capire che sei crollato prima di modificare la sezione :) Aspetto prima di leggere}
...
\ivano{il resto della sez e' strutturato cosi...}
...
\begin{wrapfigure}{l}{0.4\textwidth}
	\begin{center}
	\includegraphics[width=0.38\textwidth]{figures/slicingIdea.png}
	\end{center}
	\caption{Rationale for the slicing mechanism}
