...
\marco{non so se Ë sufficiente, gi‡ sono tre pagine se ci aggiungo pure altre immagini raddoppiamo...}
...
As can be seen in Figure \ref{fig:slicing}.a, the slicing algorithm is realized as a model-to-model transformation called \textit{MMslicer}.
...
A LIVELLO MODELLO, NON CE NE FREGA DEI MODELLI VERI E PROPRI (perch√® abbiamo fatto l'assunzione), MA CE NE FREGA DI ADATTARE LE TRASFORMAZIONI
